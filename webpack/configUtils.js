...
const DEFINE_PLUGIN = new webpack.DefinePlugin({
  ...
  'process.env.STEEMCONNECT_CLIENT_ID': JSON.stringify(
    process.env.STEEMCONNECT_CLIENT_ID || 'steemservice',
  ),
  'process.env.STEEMCONNECT_REDIRECT_URL': JSON.stringify(
    process.env.STEEMCONNECT_REDIRECT_URL || 'https://www.steemservice.com/callback',
  ),
  ...
  'process.env.SIGNUP_URL': JSON.stringify(
    process.env.SIGNUP_URL || 'https://www.steempeople.com/', // || 'https://signup.steemit.com/?ref=busy',
  ),
